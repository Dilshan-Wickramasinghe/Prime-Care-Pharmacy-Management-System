...
?>
<?php
$user_type = 'pharmacist'; // Set user type as customer
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>Welcome | Pharmacist Dashboard</title>
    <!-- Google Fonts -->
    ...
    <section class="content">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-teal align-right" style="background-color:#333 !important;">
                <li class="active"><a href="javascript:void(0);">Pharmacist Dashboard</a></li>
            </ol>
