                    ...
                    <form method="post" enctype="multipart/form-data">    
                        <div class="body">
                            ...
                            <label >Expiration</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="date"  class="form-control" placeholder="" name="expiration">
                                    </div>
                                </div>
                        </div>
                </div>
...
if(isset ($_GET['delete_id'])){
  $sql = "DELETE FROM stock_list WHERE id =".$_GET['delete_id'];
...
{
  window.location.href='view_inventory.php?delete_id='+id;
  }
}
