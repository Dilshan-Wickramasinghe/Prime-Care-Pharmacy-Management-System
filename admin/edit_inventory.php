    ...
    <div class="modal-content">
                        ...
                        <div class="body">
                            <label >Code</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" placeholder="" name="code" value="<?php echo $code; ?>" required>
                                    </div>
                                </div>
                            <label >Quantity</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" placeholder="" name="quantity" value="<?php echo $quantity; ?>" required>
                                    </div>
                                </div>
                            <label >Expire Date</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="date"  class="form-control" placeholder="" name="expiration" value="<?php echo $expiration; ?>" required>
                                    </div>
                                </div>
                    </div>
                </div>
        ...
        <div class="modal-footer"> 
            <div class="form-group"> 
                ...
                <a href="view_inventory.php"><button type="button" class="btn btn-danger m-t-15 waves-effect">Cancel</button></a>
            </div> 
        </div>
