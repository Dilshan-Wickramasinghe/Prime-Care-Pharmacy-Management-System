                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <button  type="button" class="btn btn-info waves-effect" data-toggle="modal" data-target="#myModal"> <i class="fa fa-user-plus m-r-5" style="color:white"></i> <span>Add New Category</span> </button>
                                </li>
                            </ul>
                        </div>
...
<!-- Insert category data to databse -->
<?php
...
if (isset($_POST['submit'])) {
    ...
    // insert value category_list table
   $quary = "INSERT INTO category_list(name,description) 
...
if(isset ($_GET['delete_id'])){
  $sql = "DELETE FROM category_list WHERE id =".$_GET['delete_id'];
