                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li>
                                    <button  type="button" class="btn btn-info waves-effect" data-toggle="modal" data-target="#myModal"> <i class="fa fa-user-plus m-r-5" style="color:white"></i> <span>Add New Product</span> </button>
                                </li>
                            </ul>
                        </div>
                    ...
                    <form method="post" enctype="multipart/form-data">    
                        <div class="body">
                            ...
                            <label >Dose</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  class="form-control" placeholder="" name="dose" required>
                                    </div>
                                </div>
                            ...
                            <label >Image of product</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="image" type="file" onchange="img001(this);"  required>
                                        <img style="width: 100px;height:auto" id="img01" src="#" alt=""/>
                                            <script>
...
?>
                                        ...
                                        <tr>
                                           <td><?= $id ;?></td>
                                            ...
                                            <td>
                                               <?php if ($p_status == 1) { ?>
                                                <span class="btn-success" style="padding:5px"><?php  echo "Available";}?> </span>
                                                <?php if ($p_status == 0) { ?>
                                                <span class="btn-danger" style="padding:5px"><?php  echo "Unavailable";}?> </span>
                                            </td>                                  
                                             <td>
...
if (isset($_POST['submit'])) {
    ...
    // insert value product_list table
    
   $quary = "INSERT INTO product_list(category_id,brand,name,description,dose,price,image_path,status) VALUES ('$category','$brand','$name','$description','$dose','$price','$image','$status')";
...
if(isset ($_GET['delete_id'])){
  $sql = "DELETE FROM product_list WHERE id =".$_GET['delete_id'];
