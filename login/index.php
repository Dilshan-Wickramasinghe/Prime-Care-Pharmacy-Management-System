...
<body class="login-page" style="background-color: #ffffff;">
    <div class="login-box">
        ...
        <div class="logo" style="text-align: center;">
            <img src="" style="width:auto; height: 140px;" >
        </div>

        <div class="card" style="border-radius: 10px;">
            <div class="body">
                <form id="sign_in" method="POST" action="login.php">
                    <div style="text-align: center; border-bottom: 1px solid #2196f3"><h4 style="color: #2196f3"><b>Pharmacy</b> </h4> <h4 style="color: #888888">Management System</h4></div>
